...
int main() {
   /* Polynomial poly1({-1, 1});
    ...
    int vectorSize = 4;// Change this to the size you want
    ...
    std::cout << resultKaratsubaParallel << "\n";
    std::cout << resultKaratsubaSequential << "\n";
    std::cout << resultRegularSequential << "\n";
    std::cout << resultRegularParallel << "\n";
    return 0;
}
